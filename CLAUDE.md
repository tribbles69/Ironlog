...
**Every version bump also adds an entry to the top of `CHANGELOG.md`** (repo root — the app shows it as What's new), in
...
Everything else (roadmap, specs, notes, data sources, build tools,
